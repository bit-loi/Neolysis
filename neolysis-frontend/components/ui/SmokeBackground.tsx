...
class Renderer {
  ...
  updateScale(containerWidth?: number, containerHeight?: number) {
  ...
  render(now = 0) {
    ...
    gl.uniform2f((program as unknown as Record<string, WebGLUniformLocation | null>).resolution, canvas.width, canvas.height);
    gl.uniform1f((program as unknown as Record<string, WebGLUniformLocation | null>).time, now * 1e-3);
    gl.uniform3fv((program as unknown as Record<string, WebGLUniformLocation | null>).u_color, this.color);
