...
class SequenceValidationService:
    def validate(self, sequence_text: str, name: Optional[str] = None) -> SequenceValidationResult:
        ...
        if detected_format == "fasta" and len(fasta_names) > 1:
            warnings.append("Multiple FASTA records were detected; sequences were concatenated for analysis.")
        ...
        if len(cleaned) > 5000:
            warnings.append("Sequence is long; feature extraction remains approximate.")
